...
the steepness of the hormetic component is fixed at 1. The four free
...
- [`CRS.5a()`](https://hreinwald.github.io/drc/reference/CRS.5a.md) —
  the five-parameter CRS model with alpha = 1.

- [`UCRS.4a()`](https://hreinwald.github.io/drc/reference/UCRS.4a.md) —
  the unconstrained four-parameter CRS model with alpha = 1.
