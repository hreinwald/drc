#' @title Log-normal (log-Gaussian) biphasic dose-response model
#'
#' @description
#' Model function for fitting symmetric or skewed bell-shaped/biphasic dose-response patterns
#' using the log-Gaussian model. This is the log-transformed variant of the \code{\link{gaussian}} model.
#'
...
#' @param loge logical indicating whether or not e or log(e) should be a parameter in the model.
#'   By default e is a model parameter.
#'
#' @return The value returned is a list containing the nonlinear function, the self starter function
#'   and the parameter names.
#'
#' @author Christian Ritz
#'
#' @seealso \code{\link{gaussian}}, \code{\link{drm}}
#'
