...
```{r model-comparison, fig.alt=c("NEC.2 model fitted to ryegrass data with both asymptotes constrained", "NEC.3 model fitted to ryegrass data with lower asymptote fixed at zero", "NEC.4 model fitted to ryegrass data with all parameters estimated")}
